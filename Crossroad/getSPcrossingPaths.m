function buchiAutomata = getSPcrossingPaths(crossingDirections)
%GETSPCROSSINGPATHS Generate a safety property that prohibits two
%directions are driven at the same time.
...
buchiAutomata = BuchiAutomata(states, symbols, transitions, initialStates, finalStates);
