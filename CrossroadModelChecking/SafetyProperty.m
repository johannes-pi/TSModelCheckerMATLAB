classdef SafetyProperty < BuchiAutomata
    %SAFETYPROPERTY A property that prohibits two directions are driven at the
    %same time.
    %   This is a specific Büchi Automata.
    
    methods
        function obj = SafetyProperty(crossingDirections)
            %SAFETYPROPERTY  A property that prohibits two directions are driven at the
            %same time.
